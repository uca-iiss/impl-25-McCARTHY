...
class TestTrabajadores(unittest.TestCase):
    ...
    def test_instancias(self):
        ...
        fs = Fullstack("Laura", 5, "JavaScript", "Sketch", 45000, 3)
        ux = UXEngineer("Pepe", 6, "Adobe XD", "ADA", "UX Writing", 42000, 2)
    ...
    def test_trabajar(self):
        ...
        fs = Fullstack("Fran", 10, "Python", "Figma", 50000, 2)
        self.assertIn("Fran (Fullstack) está:", fs.trabajar())

        ux = UXEngineer("Leo", 11, "Sketch", "ADA", "Research", 43000, 4)
    ...
    def test_salario_anual(self):
        ...
        ux = UXEngineer("Pepe", 6, "Adobe", "ADA", "UX Writing", 42000, 2)
